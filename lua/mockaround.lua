...
if not INGAME then
    ...
    wplist["Space Coord"] = {pos="::pos{0,0,-13234464.0000,55765536.0000,465536.0000}", opt={} }
    ...
    routes["Garni"].points = {
        ...
        [4] = {pos="::pos{0,0,-13234464.0000,55765536.0000,465536.0000}", waypointRef="Space Coord", opt={ margin=2, finalSpeed=10 }} }
